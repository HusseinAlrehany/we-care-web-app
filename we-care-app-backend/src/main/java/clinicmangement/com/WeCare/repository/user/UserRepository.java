package clinicmangement.com.WeCare.repository.user;

import clinicmangement.com.WeCare.DTO.UserProfileDTOProjection;
...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    @Query("""
            SELECT new clinicmangement.com.WeCare.DTO.UserProfileDTOProjection
